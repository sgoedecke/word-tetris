...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _WordTetris = __webpack_require__(25);

	var _WordTetris2 = _interopRequireDefault(_WordTetris);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	(0, _reactDom.render)(_react2.default.createElement(_WordTetris2.default, null), document.getElementById('app'));
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _LetterGrid = __webpack_require__(26);

	var _LetterGrid2 = _interopRequireDefault(_LetterGrid);
	...
	var _FoundWords = __webpack_require__(30);

	var _FoundWords2 = _interopRequireDefault(_FoundWords);
	...
	var WordTetris = function (_React$Component) {
	  _inherits(WordTetris, _React$Component);

	  function WordTetris(props) {
	    _classCallCheck(this, WordTetris);
	  ...
	  _createClass(WordTetris, [{
	    ...
	    value: function handleKeys(event) {
	      ...
	      var oldLetters = JSON.parse(JSON.stringify(this.state.letters));
	      var lastLetter = oldLetters[oldLetters.length - 1];
	      ...
	      if (oldLetters.slice(0, oldLetters.length - 1).find(function (l) {
	        return l.x == lastLetter.x && l.y == lastLetter.y;
	      })) {
	        return;
	      } else {
	  ...
	  return _react2.default.createElement(
	    ...
	    _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        'tbody',
	        null,
	        [].concat(_toConsumableArray(Array(_constants.GAME_HEIGHT))).map(function (_, hi) {
	          return _react2.default.createElement(
	            'tr',
	            { key: hi },
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _words = __webpack_require__(29);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var FoundWords = function FoundWords(_ref) {
	  var words = _ref.words;
	  return _react2.default.createElement(
	    'table',
	    { className: 'foundWords', height: _constants.GAME_HEIGHT * 42 + 'px' },
	    _react2.default.createElement(
	      'tbody',
	      null,
